...
namespace FrameConsoleApp
{
    ...
    /// CallContext的GetData/SetData方法不支持夸线程调用，需要修改为LogicalGetData/LogicalSetData方法，或者，让CallStackContext实现ILogicalThreadAffinative接口
    /// </summary>
    class ThreadStaticWayCrossThread
    {
